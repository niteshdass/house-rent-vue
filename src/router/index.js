...
import PropertyDetails from '@/views/Presentation/PropertyDetails.vue';
import AddListing from '@/views/add-listing/AddListing.vue';
import Profile from '@/views/Presentation/Profile.vue';
import Chat from '@/views/Presentation/Chat.vue';
